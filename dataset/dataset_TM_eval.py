...
class Text2MotionDataset(data.Dataset):
    def __init__(self, dataset_name, is_test, w_vectorizer, feat_bias = 5, max_text_len = 20, unit_length = 4):
        ...
        if dataset_name == 't2m':
            ...
            self.meta_dir = './checkpoints/kit/Comp_v6_KLD005/meta'
    ...
    def __getitem__(self, item):
        ...
        motion, m_length, text_list, key_point = data['motion'], data['length'], data['text'], data['key_points']
        ...
        return word_embeddings, pos_one_hots, caption, sent_len, motion, m_length, '_'.join(tokens), name, key_point
